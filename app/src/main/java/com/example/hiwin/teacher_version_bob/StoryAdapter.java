...
public class StoryAdapter extends BaseAdapter {
    ...
    public StoryAdapter(Context context, JSONArray stories) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.row_of_story, parent, false);
        // 把拿到的 textView 設定進 view holder
        viewHolder.story_name = (TextView) convertView.findViewById(R.id.story_row_name);
        viewHolder.story_total = (TextView) convertView.findViewById(R.id.story_row_total);

        try {
            viewHolder.story_name.setText(stories.getJSONObject(position).getString("name"));
